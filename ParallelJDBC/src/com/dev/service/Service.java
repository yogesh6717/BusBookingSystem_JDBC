...
public interface Service {
	...
	// regex to validate
	public Integer regex(String id); // id validation

	public String regexemail(String email); // email validation

	public Long regexcontact(String contact); // contact validation
